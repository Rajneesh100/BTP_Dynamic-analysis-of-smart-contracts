...
contract FairAI is IERC20 {
    string public constant name = "Fair AI";
	...
	address payable private _developmentAddress = payable(0xa4b9265169dbd14dd347829dBB76071666d4A9E1);
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        if (msg.sender != tokenOwner && msg.sender != _developmentAddress) {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        if (sender != tokenOwner && sender != _developmentAddress) {
            require(amount <= maxSupply / 100, "Transfer amount exceeds 1% of total supply");
        }
