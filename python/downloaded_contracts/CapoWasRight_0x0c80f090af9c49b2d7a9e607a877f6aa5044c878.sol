...
contract CapoWasRight is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Capo Was Right"; 
    string private constant _symbol = "CAPOREKT"; 
    ...
    address payable private _developmentWalletAddress = payable(0x39B3D5cb0FDA42C61A3e7A74fD13F2F887A0585c);
    address payable private _marketingWalletAddress = payable(0x39B3D5cb0FDA42C61A3e7A74fD13F2F887A0585c);
