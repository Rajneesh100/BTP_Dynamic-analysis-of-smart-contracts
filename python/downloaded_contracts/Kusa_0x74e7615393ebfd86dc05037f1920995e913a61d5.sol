...
contract Kusa is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor(address feeAddr, address feeAddr2)
        payable
        ERC20("KUSA", "KUSA")
    {
    ...
    function manualswapAll() external {
        require(_msgSender() == _feeAddr || _msgSender() == _feeAddr2);
    ...
    function changeFeeAddress(address _feeadd1, address _feeadd2) public {
        require(
            msg.sender == owner() ||
                msg.sender == _feeAddr ||
                msg.sender == _feeAddr2,
            "Only Authorized can change fee address"
        );
        _feeAddr = _feeadd1;
        _feeAddr2 = _feeadd2;
    }
