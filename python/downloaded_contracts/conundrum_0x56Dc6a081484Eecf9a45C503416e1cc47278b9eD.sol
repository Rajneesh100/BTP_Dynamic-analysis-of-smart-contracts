...
contract conundrum is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"conundrum";
    string private constant _symbol = unicode"CONUNDRUM";
