...
contract FrogHatDog is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FrogHatDog";
    string private constant _symbol = unicode"FrogHatDog";
