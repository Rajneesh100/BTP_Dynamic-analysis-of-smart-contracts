...
contract BANANA is Context, IERC20, Ownable {
    ...
    uint256 private _endBuyTax=3;
    uint256 private _endSellTax=5;
    ...
    string private constant _name = unicode"CHIMPANZEE";
    string private constant _symbol = unicode"BANANA";
    uint256 public _txLimit = 13808413808 * 10**_decimals;
    uint256 public _walletLimit = 13808413808 * 10**_decimals;
    uint256 public _swapbackThreshold= 6904206904 * 10**_decimals;
    uint256 public __swapbackLimit= 6904206904 * 10**_decimals;
