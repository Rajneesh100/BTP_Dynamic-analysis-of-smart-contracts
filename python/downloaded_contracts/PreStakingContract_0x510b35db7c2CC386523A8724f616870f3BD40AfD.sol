...
contract PreStakingContract is AccessControl {
    ...
    */
    function withdraw(address _beneficiary, uint256 _amount) external onlyWithAdminRole {
        require(!isStakingTokensActive, "PreStaking: Staking is not pause yet");
    ...
    */
    ...
    /**
    * @dev Retrieves the token balance staked by the address.
    * @return The balance of tokens staked by the address.
    */
