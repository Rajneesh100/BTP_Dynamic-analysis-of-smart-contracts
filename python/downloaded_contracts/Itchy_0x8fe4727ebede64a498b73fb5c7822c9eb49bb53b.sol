...
Web: http://itchyandscratchy.fun/
X: https://twitter.com/ItchycoinETH
TG: https://t.me/itchyandscratchyshow
...
contract Itchy is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Itchy and Scratchy Show";
    string private constant _symbol = unicode"ITCHY";
    ...
    function OpenItchy() external onlyOwner() {
