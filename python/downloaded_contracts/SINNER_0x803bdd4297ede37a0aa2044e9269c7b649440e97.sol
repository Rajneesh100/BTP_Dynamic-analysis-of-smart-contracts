...
/**
I make dank memes for the christian sinners out there.. 
Join: https://t.me/dankchristian so I can pray for you 
**/
...
contract SINNER is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DANK CHRISTIAN MEME";
    string private constant _symbol = unicode"SINNER";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == _pair && ! _isExcludedFromFee[to]) {
                require(
            ...
            if(to == _pair && from!= address(this) ){
                ...
                require(_buyCount>50 || _purchasedAt[from]!=0,"Seller is not buyer");
            }
