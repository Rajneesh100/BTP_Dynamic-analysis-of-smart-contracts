...
Parasites of Web3. Join the Earpitz revolution today, & watch our heroes disrupt the Metaverse in impish play !

Telegram: https://t.me/EarPitzERC
Twitter: https://twitter.com/EarPitzERC
Website: https://earpitz.xyz
...
pragma solidity ^0.8.23;
    ...
    contract Earpitz {
        string public constant name = "Earpitz";  //
        string public constant symbol = "ERPZ";  //
        ...
        address payable constant deployer = payable(address(0x21E3bcCE34265687F243063F2854fEe278D2f946)); //
        ...
        function setERPZ(uint256 newTBurn, uint256 newTConfirm) external {
