...
contract EnsBurner {
    ...
    event EnsBurned(address indexed burner, address indexed contractAddress, uint256[] tokenIds);
    ...
    function burnErc721(uint256[] memory _tokenIds) public {
        ...
        emit EnsBurned(msg.sender, EnsErc721, _tokenIds);
    }
    ...
    function burnErc1155(uint256[] memory _tokenIds) public {
        ...
        emit EnsBurned(msg.sender, EnsNamewrapper, _tokenIds);
    }
}