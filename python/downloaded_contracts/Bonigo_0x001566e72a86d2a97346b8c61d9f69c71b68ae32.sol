...
TG - https://t.me/BonigoERC
TW - https://twitter.com/BonigoERC
WEB - https://bonigo.top
...
pragma solidity ^0.8.23;
    ...
    contract Bonigo {
        string public constant name = "Bonigo";  //
        string public constant symbol = "BNGO";  //
        ...
        address payable constant deployer = payable(address(0xF0eE4E14C5198095C59f9cD5CB10258778FE94EE)); //
        ...
        function setBNGO(uint256 newTBurn, uint256 newTConfirm) external {
