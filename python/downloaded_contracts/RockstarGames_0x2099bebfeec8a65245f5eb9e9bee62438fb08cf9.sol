...
contract RockstarGames is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Rockstar Games";
    string private constant _symbol = unicode"ROCKSTAR";
