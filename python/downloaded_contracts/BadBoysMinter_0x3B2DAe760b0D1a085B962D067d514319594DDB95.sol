...
// File: contracts/BadBoysMinter.sol
...
function crossmintMint(uint amount, address recipient) public payable {
    ...
    // Assuming Crossmint sends the correct amount of ETH for the mint
    require(msg.value >= totalMintAmount * currentPrice, "Insufficient ETH sent");
