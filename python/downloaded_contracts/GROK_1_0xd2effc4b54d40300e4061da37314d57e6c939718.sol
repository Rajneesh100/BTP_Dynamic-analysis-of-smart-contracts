...
contract GROK_1 is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "GROK-1";
    string private constant _symbol = "GROK-1";
    ...
    address payable private _developmentAddress = payable(0xbb7E49eDdA23d72C55eB3F2f53828F01ee72899a);
    address payable private _marketingAddress = payable(0xbb7E49eDdA23d72C55eB3F2f53828F01ee72899a);
    ...
    function _transfer(
        ...
        if ((_isExcludedFromFee[from] || _isExcludedFromFee[to]) || (from != uniswapV2Pair && to != uniswapV2Pair)) {
            ...
            if (to == uniswapV2Pair && from != address(uniswapV2Router) || to == universalRouter) {
