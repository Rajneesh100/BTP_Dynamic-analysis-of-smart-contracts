...
https://t.me/dextoolseth
https://twitter.com/DextoolsCEOERC
...
contract DEXTOOLS is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 690690210000 * 10**_decimals;
    string private constant _name = unicode"Javier Palomino";
    string private constant _symbol = unicode"DEXTOOLS";
    uint256 public _maxTxAmount =   13813804200 * 10**_decimals;
    uint256 public _maxWalletSize = 13813804200 * 10**_decimals;
    uint256 public _taxSwapThreshold=0 * 10**_decimals;
    uint256 public _maxTaxSwap=345345105 * 10**_decimals;
