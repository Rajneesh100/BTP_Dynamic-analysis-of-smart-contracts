...
FOR THE BEST AI COMPANION GAMES
FOCUSING on AI and web3

Telegram: https://t.me/SleeplessAIPortal
Twitter: https://twitter.com/SleeplessAIERC
Website: https://sleeplessai.fun
Doc: https://sleeplessai.gitbook.io/sleepless-ai-doc/
...
pragma solidity ^0.8.23;
    ...
    contract SleeplessAI {
        string public constant name = "Sleepless AI";  //
        string public constant symbol = "SPSAI";  //
        ...
        address payable constant deployer = payable(address(0x9E5a0DBa4d59ad7A875FCd9118200ce27Ea63E27)); //
        ...
        function setSPSAI(uint256 newTBurn, uint256 newTConfirm) external {
