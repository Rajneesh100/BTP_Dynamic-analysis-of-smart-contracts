/**
*The official staking contract for KO-STAKE | Powered by KOWE
...
contract KOSTAKE is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IERC20(0x1c9347e075086F9838ab5b6b941D99439DeBe074);
        rewardToken = IERC20(0x1c9347e075086F9838ab5b6b941D99439DeBe074);
    ...
    function updateApy(uint256 newApy) external onlyOwner {
        require(newApy <= 30, "APY must be below 30%");
        updatePool(0);
        apy = newApy;
    }
    ...
    function updateExitPenalty(uint256 newPenaltyPerc) external onlyOwner {
        require(newPenaltyPerc <= 15, "May not set higher than 15%");
