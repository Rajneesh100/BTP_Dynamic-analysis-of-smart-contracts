...
// File: contracts/NFThugzLegendz.sol



    contract NFThugzLegendz is Ownable, ERC721A, IERC2981, ReentrancyGuard, DefaultOperatorFilterer {

        constructor(
            address initialOwner
        )
            ERC721A("NFThugz Legendz", "THGZ")
