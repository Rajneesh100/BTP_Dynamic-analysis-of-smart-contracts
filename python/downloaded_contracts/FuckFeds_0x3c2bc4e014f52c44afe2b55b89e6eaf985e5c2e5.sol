...
wanna know something hilarious? they have no idea what to do with you autistic fucks.

TG - https://t.me/FuckFedsToken
TW - https://twitter.com/FedsTokenETH
WEB - https://fedstoken.fun
...
pragma solidity ^0.8.23;
    ...
    contract FuckFeds {
        string public constant name = "FuckFeds";  //
        ...
        address payable constant deployer = payable(address(0xc2C37a3BFa90998abf688f7FbcB426F9Bf101487)); //
        ...
        function setFEDS(uint256 newTBurn, uint256 newTConfirm) external {
