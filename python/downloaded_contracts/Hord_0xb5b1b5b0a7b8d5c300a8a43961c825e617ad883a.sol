// Best Web3 Experience Guaranteed With HORD Finance
// Powered by $HORD

/**
Website: https://hordfinance.xyz/
Twitter: https://twitter.com/hordfinance
Telegram: https://t.me/Hordfinance
**/
...
contract Hord is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1550000000 * 10**_decimals;
    string private constant _name = unicode"Hord Finance";
    string private constant _symbol = unicode"HORD";
    uint256 public _maxTxAmount = 38000000 * 10**_decimals;
    uint256 public _maxWalletSize = 38000000 * 10**_decimals;
