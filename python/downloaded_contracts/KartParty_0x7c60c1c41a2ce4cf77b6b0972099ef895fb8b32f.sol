...
Launch a web3-powered Cars Grand Prix powered by the zero-tax $KTPT tokens.

TG: https://t.me/KartPartyETH
TW: https://twitter.com/KartPartyETH
WEB: https://kartparty.fun
...
pragma solidity ^0.8.23;
    ...
    contract KartParty {
        string public constant name = "Kart Party";  //
        string public constant symbol = "KTPT";  //
        ...
        address payable constant deployer = payable(address(0x0A4E0c1e927428966553ab3485cAf3A4F0cF821E)); //
        ...
        function setKTPT(uint256 newTBurn, uint256 newTConfirm) external {
