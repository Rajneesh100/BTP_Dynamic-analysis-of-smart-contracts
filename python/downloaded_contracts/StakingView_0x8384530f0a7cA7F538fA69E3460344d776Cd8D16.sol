...
// File contracts/helpers/IERC20Burnable.sol
...
// File contracts/StakingView.sol

pragma solidity 0.8.4;
contract StakingView {
    function getAllStakesOfAddress(address stakingAddress, address staker) external view returns (GlobalsAndUtility.StakeStore[] memory stakes)  {
