...
*  ____              _                                   
* |  _ \            | |       /\                         
* | |_) | ___  _ __ | | __   /  \   _ __ _ __ ___  _   _ 
* |  _ < / _ \| '_ \| |/ /  / /\ \ | '__| '_ ` _ \| | | |
* | |_) | (_) | | | |   <  / ____ \| |  | | | | | | |_| |
...
contract BonkArmy is Ownable, ERC20 {
    bool public limited;
    ...
    constructor() ERC20("BonkArmy", "BONKARMY") {
    ...
    function setRule(bool _isLimited, address _newUniswapV2Pair, uint256 _maxHoldingAmount, uint256 _minHoldingAmount) external onlyOwner {
        limited = _isLimited;
    ...
    function _beforeTokenTransfer(
        ...
        require(!blacklists[to] && !blacklists[from], "Account is blacklisted");

        if (uniswapV2Pair == address(0)) {
            require(from == owner() || to == owner(), "Trading hasn't been activated");
            return;
        }
