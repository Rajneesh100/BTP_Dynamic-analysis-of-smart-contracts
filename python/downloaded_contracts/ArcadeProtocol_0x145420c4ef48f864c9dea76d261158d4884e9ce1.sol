...
contract ArcadeProtocol is Ownable {
    address payable public prizePoolContract;
    ...
    constructor(address _prizePoolContract, address _revenueShareWallet) Ownable(msg.sender) {
        prizePoolContract = payable(_prizePoolContract);
        revenueShareWallet = payable(_revenueShareWallet);
    ...
    function distributeFunds() external payable {
        ...
        uint256 revenueShareAmount = address(this).balance - prizePoolAmount;
