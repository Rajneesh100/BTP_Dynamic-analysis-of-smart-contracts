...
contract GROKC is ERC20, Ownable {
    ...
    constructor () ERC20("Grok Christmas", "GROKC") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x62738F3901EDB19Ee266F48eabeEDaA841E19c4d);
        ...
        feeReceiver = 0x62738F3901EDB19Ee266F48eabeEDaA841E19c4d;
        ...
        _mintOnce(owner(), 69e8 * (10 ** decimals()));
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        uint256 _totalFees;
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping || block.timestamp >= tradingTime + 3 hours) {
            _totalFees = 0;
