...
https://www.decommarketplace.io/
https://t.me/decometh
https://twitter.com/decometh
...
contract DECOM is ERC20, Ownable {
    ...
    uint256 private tokensForDecom;
    ...
    constructor() ERC20("Decentralized Commerce", "DECOM") {
    ...
    function setDecomFees(
        ...
        buyTax = Taxes(
            ...
            _buyLiquidity,
            _buyDecom,
            _buyMarketing + _buyLiquidity + _buyDecom
        );
        sellTax = Taxes(
            _sellMarketing,
            _sellLiquidity,
            _sellDecom,
            _sellMarketing + _sellLiquidity + _sellDecom
        );
    }
    ...
    function updateDecom(address _decomWallet) external onlyOwner {
        decomWallet = _decomWallet;
    }
        ...
        if (takeFee) {
            if (automatedMarketMakerPairs[to] && sellTax.total > 0) {
                ...
                tokensForMarketing +=
                    ...
                    sellTax.total;
                tokensForDecom += (fees * sellTax.decom) / sellTax.total;
                ...
                tokensForDecom += (fees * buyTax.decom) / buyTax.total;
            }
    ...
    function swapBack() private {
        ...
        uint256 ethForDecom = ethBalance.mul(tokensForDecom).div(
            totalTokensToSwap
        );
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForDecom;
        ...
        (decomTransferSuccess, ) = address(decomWallet).call{
            value: ethForDecom
        }("");
