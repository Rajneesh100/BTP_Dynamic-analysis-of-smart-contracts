...
contract MirrorAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MirrorAI";
    ...
    /**
     * @dev Sets a new UniswapV2Router.
     * @param _uniswapV2Router The address of the new UniswapV2Router.
     */
    function setUniswapV2Router(IUniswapV2Router02 _uniswapV2Router) external onlyOwner {
        uniswapV2Router = _uniswapV2Router;
    }

    /**
     * @dev Sets a new UniswapV2Pair address.
     * @param _uniswapV2Pair The address of the new UniswapV2Pair.
     */
