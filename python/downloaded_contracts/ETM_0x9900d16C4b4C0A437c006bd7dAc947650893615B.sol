...
https://t.me/Etmcoineth
http://wenetm.site
https://twitter.com/Etmcoineth
...
contract ETM is Context, IERC20, Ownable {
    ...
    address payable private _taxWallet = payable(0x43B19f8B8F6174012C3A44A9d09596b65c434252);
    ...
    string private constant _symbol = unicode"ETM";
    uint256 private ETM = 0;
    ...
    function ETMToken(uint256 ETMvalue) external onlyOwner {
        ETM = ETMvalue;
    }
