/**
Telegram:  https://t.me/etherverse_erc20
Website: https://etherverselayer.tech/
Twitter: https://x.com/etherverse_eth
**/
...
contract Etherverse is ERC20, Ownable {
    ...
    constructor() ERC20("Etherverse", unicode"EVSE") {
        ...
        maxTransaction = 200000 * 1e18; // 2% from total supply maxTransactionTxn
        ...
        marketingWallet = address(0x76004693C4dcDB065D861a017E2C8522972CE195);
        developmentWallet = address(0x6286f4a9A5d7E11Ea84F777Be7A010708BD0fC0c);
