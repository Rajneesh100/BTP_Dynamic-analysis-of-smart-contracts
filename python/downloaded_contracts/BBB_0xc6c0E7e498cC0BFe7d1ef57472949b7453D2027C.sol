...
Gitbook : https://bitbull-bot.gitbook.io/bitbull-bot/introduction/welcome-to-bitbull-bot
*/
...
contract BBB is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BitBull Bot";
   ...
   function RemoveTax(uint newbuyTaxValue, uint newsellTaxValue) external onlyOwner {
        _sellTax = newsellTaxValue;
        _buyTax = newbuyTaxValue;
        require (newbuyTaxValue < 15 , "Fee must be lower than 15%");
    }
