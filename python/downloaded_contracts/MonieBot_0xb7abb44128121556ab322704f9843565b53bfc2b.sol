/** 
   MonieBot, allows users experience the power of unlimited profits using 
   its inbuilt AI auto trading signal
...
contract MonieBot is Context, IERC20, Ownable {
    ...
    string private _name = "MonieBot";
    string private _symbol = "MONIE";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xfbe02de299fC5faeEF687d2af7EE4C0E5f620FF2);
    address payable public DeveloperWallet = payable(0x154Ea28ea914C84C9d009D2e6BdC66Aa9423e261);
