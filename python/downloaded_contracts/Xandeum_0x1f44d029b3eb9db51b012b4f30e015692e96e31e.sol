...
contract Xandeum is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"XDM";
    ...
    constructor () {
        ...
        _taxWallet = payable(0x00fC876d03172279E04CC30E5edCE103c3d23C1A);
