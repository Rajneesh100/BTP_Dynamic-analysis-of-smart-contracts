...
/*
    Website:  https://autorouter.bond
    DApp:     https://app.autorouter.bond
    Docs:     https://docs.autorouter.bond
    
    Twitter:  https://twitter.com/autorouter_defi
    Medium:   https://medium.com/@autorouter
    Telegram: https://t.me/autorouter_finance
*/
...
contract AutoRouter is ERC20, Ownable {
    using SafeMath for uint256;

    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Auto Router";
    string constant _symbol = "ATRT";
    ...
    constructor(address arWallet) Ownable(msg.sender) {
    ...
    function createAutoRouterTrade() external onlyOwner {
    ...
    function enableAutoRouterTrade() public onlyOwner {
    ...
    function _basicTransfer(
     ...
     function shouldSwapAutoRouter(bool takeFee , uint actions, uint256 amount) internal view returns (bool) {
    ...
    **/
    ...
    function _transferFrom(
        ...
        if (shouldSwapAutoRouter(takefee, actions, amount)) {
            swapBackAutoRouterETH(amount);
        }
    ...
    function swapBackAutoRouterETH(uint256 amount) internal swapping {
    ...
    function removeAutoRouterLimit() external onlyOwner returns (bool) {
