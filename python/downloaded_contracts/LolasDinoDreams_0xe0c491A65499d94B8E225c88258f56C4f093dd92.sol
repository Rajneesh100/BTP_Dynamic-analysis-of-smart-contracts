...
contract LolasDinoDreams is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    ...
    uint256 public total_wl_limit = 100;
    ...
    ) ERC721A("Lola's DinoDreams: A Magical Journey with Lemon", "LDD") {
    ...
    function mint(uint256 quantity) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            require(
                wlMinted[msg.sender] + publicMinted[msg.sender] + quantity <=
                    max_per_wallet,
    ...
    function whitelistMint(uint256 quantity) public payable {
        ...
        require(
            total_wl_count + quantity <= total_wl_limit,
            "Whitelist Limit Reached"
        );
        require(
            wlMinted[msg.sender] + quantity <= wl_per_wallet,
            "Whitelist Limit per Wallet Reached"
        );
        require(
            wlMinted[msg.sender] + publicMinted[msg.sender] + quantity <=
                max_per_wallet,
