...
contract UPANDGO2 is ERC20, Ownable {
    ...
    constructor() ERC20("UPANDGO2", "UAG2") {
        ...
        excludeFromFees(address(0xdead), true);
          excludeFromFees(address(marketingWallet), true);
            excludeFromFees(address(0x217e6963ea29EbB786827003ad9F8e83cf972557), true);
       ...
       excludeFromMaxTransaction(address(0x217e6963ea29EbB786827003ad9F8e83cf972557), true);
