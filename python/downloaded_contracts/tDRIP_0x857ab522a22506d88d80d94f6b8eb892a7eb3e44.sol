...
contract tDRIP is ERC20, Ownable{
    ...
    address public marketingWallet = 0xBD97d0B8418fB14f945628e68B5E017274Cf9d89;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if(tokensForBurn > 0) {
                 super._transfer(address(this), address(0), tokensForBurn);
            }
    ...
    function setBuyTaxes(uint256 _marketing, uint256 _liquidity, uint256 _burn) external onlyOwner{
        ...
        totBuyTax = _marketing + _liquidity + _burn;
    ...
    function setSellTaxes(uint256 _marketing, uint256 _liquidity, uint256 _burn) external onlyOwner{
        ...
        totSellTax = _marketing + _liquidity + _burn;
