...
WEB : https://www.blrerc.xyz
TG : https://t.me/bladrunnererc
X : https://x.com/bladrunnererc20
...
contract BLR is Context , IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"Blade Runner AI Killer";
    string private constant _symbol = unicode"BLR";
    ...
    function KillFee(uint256 _buy, uint256 _sell ) external onlyOwner {
    require(_buy <= 25 && _sell <= 25, "Fees cannot exceed 25%");
      _buyTax = _buy;
      _sellTax = _sell;
    }
