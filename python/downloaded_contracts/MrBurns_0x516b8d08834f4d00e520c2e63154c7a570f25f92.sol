/**
Mr Burns, is the main antagonist of The Simpsons franchise. 
He is a magic person like the Simpsons and wants to be rich cuz he is a degen every day.

Website: https://themrburns.com
Portal: https://t.me/MrBurns_Token
Twitter: https://x.com/mrburnsdoteth
...
contract MrBurns is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1_000_000_000 * 10 ** _decimals;//Max Tx 2.0%
    uint256 public _maxWalletSize = 1_000_000_000 * 10 ** _decimals; //Max Walelt 2.0%
    uint256 public _taxSwapThreshold = 3_000_000 * 10 ** _decimals; //TaxSwapThreshold 0.3%
    uint256 public _maxTaxSwap = 30_000_000 * 10 ** _decimals; //Max TaxSwap 3%
