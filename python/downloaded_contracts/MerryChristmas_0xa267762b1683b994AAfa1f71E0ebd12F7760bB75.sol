...
🕸  Website      https://fcksanta.wtf/
✅ Telegram     https://t.me/santaai_2024
✖️ Twitter/X    https://twitter.com/SantaHubAI
...
contract MerryChristmas is Context, IERC20, Ownable {
    ...
    uint256 public _buyTaxfees=10;
    uint256 public _sellTaxfees=40;
    uint256 private _preventSwapBefore=5;
    uint256 private _buyCount=0;
    uint256 private _swapThreshold = _tTotal / 1000;
    uint256 private _maxTaxfeeswap = _tTotal * 2 / 100;
    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 202_400_000 * 10 ** 18;
    uint256 public _maxWallet = _tTotal * 3 / 100;
    
    address private uniswapV2Pair;
    bool private inSwap = false;
    bool private swapEnabled = false;
    string private constant _name = unicode"SantaHub AI";
