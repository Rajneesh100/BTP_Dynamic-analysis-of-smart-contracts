/*
TG:  https://t.me/ETHisKING_ERC20
X:   https://twitter.com/ETHisKING_ERC20
Web: https://www.kingeth.space
*/
...
contract KingEthContract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ETH is king";
    ...
    function openTrading() external {
        require(_msgSender()==_taxWallet || _msgSender()==_devAddress || _msgSender()==_marketingAddress);
