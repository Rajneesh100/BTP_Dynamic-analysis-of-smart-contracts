...
contract DECOM is ERC20, Ownable{
    ...
    address public marketingWallet = 0xCc5eb257C7EE88C53E97d0C1e0Dc702C3812950D;
    address public developmentWallet = 0x85137Cc1E45B0f6c732Cb23bD402E6613EF3C49B;
    address public stoicDaoWallet = 0xD2566ec4001380e79A559b53f393FCE01Af0A216;
    ...
    function setBuyTaxes(uint256 _marketing, uint256 _liquidity, uint256 _development, uint256 _stoicDao, uint256 _burn) external onlyOwner{
        ...
        require(totBuyTax <= 10,"Total buy fees cannot be greater than 5%");
    ...
    function setSellTaxes(uint256 _marketing, uint256 _liquidity, uint256 _development, uint256 _stoicDao, uint256 _burn) external onlyOwner{
        ...
        require(totSellTax <= 10,"Total sell fees cannot be greater than 5%");
