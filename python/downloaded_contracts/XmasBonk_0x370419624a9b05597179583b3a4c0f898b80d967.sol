...
contract XmasBonk is ERC20, Ownable {
    ...
    constructor() ERC20("Xmas Bonk", "XBONK") {
    ...
    function XmasBonkStartLaunch(uint256 _blocks) external payable onlyOwner {
    ...
    function limitsAreXmas() external onlyOwner {
