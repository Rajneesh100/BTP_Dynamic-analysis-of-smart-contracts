...
contract EAI is ERC20, Ownable {
    ...
    ERC20(_name, _symbol)
    {
        address newOwner = 0x1383899A165B23d05AED1b0739CAfD8fa133948e;
    ...
    function setRouter(address _v2RouterAddress) external onlyOwner {
        dexRouter = IDexRouter(_v2RouterAddress);
    ...
    function _transfer(
        ...
        amount -= handleTax(from, amount);

        super._transfer(from,to,amount);
    }

    function handleTax(address from, uint256 amount) internal returns (uint256){
        uint256 tax = 0;
