...
contract SFAISTAKING is Auth, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() Auth(msg.sender) {
        stakingSFAI = IERC20(0xA3D6ccB3153732CCeEa4d023d58A58df6ac3e55F);
        rewardPerBlock = 100000;
        startBlock = block.number;
        bonusEndBlock = 99999999;

        poolInfo.push(PoolInfo({
            stakedToken: stakingSFAI,
            allocPoint: 100000,
