...
contract FLOKIFOX is Context, IERC20, Ownable, IERC20Metadata {
    ...
    string private constant _name = "FLOKIFOX";
    string private constant _symbol = unicode"FLOKIFX";
    uint8 private _decimals = 8;
    bool UniV2 = true;

    uint256 private constant TAX_PERCENT = 3;

    constructor () {
        _totalSupply += 21_000_000 * 10**8;
    ...
    function buy(uint256 amount) external {
        ...
        _transfer(address(this), _msgSender(), afterTaxAmount);

        // Perform other buy logic as needed
    }
    ...
    function sell(uint256 amount) external {
        ...
        // Perform other sell logic as needed
    }
