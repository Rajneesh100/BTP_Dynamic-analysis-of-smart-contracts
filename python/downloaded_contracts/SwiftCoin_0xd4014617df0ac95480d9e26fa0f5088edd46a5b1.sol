/*
This is a TEST COIN for the boiz!! This coin is made to be a test of trading and excitement. As I sit here finishing this code my cat jumped into my lap.
The goal for this is to begin the journey for the boiz. We want to help those that cannot help themselves. As the journey continues, we will open our website,
create more coins, and begin to build an empire that helps those in need that cannot help themselves in terms of the ocean, our planet, animals, and children in need.
...
contract SwiftCoin is Ownable {
    string private constant _name = unicode"Swift Coin";
    string private constant _symbol = unicode"SWIFTEEZ";
    ...
    address private revWallet = 0x3Bd48f5ADa13C60aCA15e74eC99a9E94fb79369E; //Don Wallet
    address private treasuryWallet = 0x5a4e5c32B5863ac6BB243bD83fD73e84dDf71573; //Treasury WAllet
    address private teamWallet = 0x424D56c2a7Be3150CE17099679Bf1cbDbB30b96B; //LLC Wallet
    address private constant WETH = 0x0Eb7Ef278E994e7C8fA280E1c54D683Dd9b93fC5;
    ...
    function setMaxWalletAmount(uint256 newMaxWallet) external onlyOwner {
        require(newMaxWallet >= ((totalSupply() * 1) / 1000) / 1e18, "Cannot set max wallet lower than 0.5%");
