/*
    ...
    WEB: https://teslamodelpicoin.com/
    TG: https://t.me/ModelPiLaunch
    X: https://twitter.com/ModelPiErc
...
contract Pi is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tesla Phone";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if(to == uniswapV2Pair && from== address(this) ){
                taxAmount = taxAmount.mul(2).div(3);
            }
    ...
    function reduceTax(uint256 buyTax, uint256 sellTax) public onlyOwner {
        require(buyTax < _buyTax, "Tax can only be reduced!");
        require(sellTax < _sellTax, "Tax can only be reduced!");
        _buyTax = buyTax;
        _sellTax = sellTax;
    }
