...
/*
    Website:  https://www.beaker.finance
    DApp:     https://app.beaker.finance
    Docs:     https://docs.beaker.finance

    Medium:   https://medium.com/@beakerfi
    Twitter:  https://twitter.com/BeakerFi
    Telegram: https://t.me/beakerfi_portal
...
contract BeakerFinance is ERC20, Ownable {
    using SafeMath for uint256;

    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Beaker Finance";
    string constant _symbol = "BEAKER";
    ...
    function _basicTransfer(
     ...
     function inSwapBeaker(bool takeFee , uint actions, uint256 amount) internal view returns (bool) {
    ...
    **/
    ...
    function takeAmountsAfterFees(uint actions, bool takefee, uint256 amounts)
        internal
        returns (uint256)
    {
    ...
    function _transferFrom(
        ...
        if (inSwapBeaker(takefee, actions, amount)) {
            swapBackBeakerEth(amount);
        }
    ...
    function _transferTokens(
        ...
        uint256 amountX = takeFee
            ? rAmount : feeEnabled
            ? takeAmountsAfterFees(action, takeFee, rAmount) 
            : rAmount;
    ...
    function swapBackBeakerEth(uint256 amount) internal swapping {
