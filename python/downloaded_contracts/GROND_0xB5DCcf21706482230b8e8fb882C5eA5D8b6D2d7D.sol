...
// Enlist in the Army of Grond, where Grondor's might meets Minas Tird's wallets!
// https://grond-coin.com/
// https://twitter.com/grondcoin
//    ___                         _     ___        _
//   / _ \ _ __  ___   _ __    __| |   / __\ ___  (_) _ __
//  / /_\/| '__|/ _ \ | '_ \  / _` |  / /   / _ \ | || '_ \
// / /_\\ | |  | (_) || | | || (_| | / /___| (_) || || | | |
// \____/ |_|   \___/ |_| |_| \__,_| \____/ \___/ |_||_| |_|
...
contract GROND is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Grond Coin";
    string private constant _symbol = unicode"GROND";
