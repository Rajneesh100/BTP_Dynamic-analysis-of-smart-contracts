...
// File: contracts/HelloWorld3.sol


pragma solidity ^0.8.0;

// Import the ERC-20 contract from the OpenZeppelin library


// SantasWaifu contract inheriting from ERC20
contract SantasWaifu is ERC20 {
    // Address of the contract owner
    address private owner;

    // Constructor to initialize the token with a name, symbol, and initial supply
    constructor() ERC20("SantasWaifu", "xmas") {
        // Mint initial supply to the contract owner
        _mint(msg.sender, 365_000_000_000 * 10**18); // 420 billion with 18 decimal places
        owner = msg.sender;
    }
