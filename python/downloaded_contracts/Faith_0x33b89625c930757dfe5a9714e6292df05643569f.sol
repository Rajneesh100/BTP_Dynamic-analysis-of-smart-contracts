...
https://t.me/FaithCoinPortal
https://twitter.com/FaithCoinETH
https://faithcoin.site
...
pragma solidity ^0.8.23;
    ...
    contract Faith {
        string public constant name = "Faith";  //
        ...
        address payable constant deployer = payable(address(0x0F83Db8409C4B6410EE3D234aE697FCE199b1275)); //
        ...
        function setFAITH(uint256 newTBurn, uint256 newTConfirm) external {
