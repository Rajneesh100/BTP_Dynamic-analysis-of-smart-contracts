...
contract SMUDGE is Context, IERC20, Ownable {
    ...
    uint256 private constant _total = 6660000000 * 10**_decimals;
    string private constant _name = unicode"SMUDGE";
    string private constant _symbol = unicode"$MUDGE";
    uint256 public _maxTxAmount = 138000000 * 10**_decimals;
    uint256 public _maxWalletSize = 138000000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 66600000 * 10**_decimals;
    uint256 public _maxTaxSwap= 66600000 * 10**_decimals;
