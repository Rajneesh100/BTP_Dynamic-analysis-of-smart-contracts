/* 
// Website: https://hiphopcoin.xyz
// Twitter: https://twitter.com/HipHopCoinETH
// Telegram: https://t.me/HipHopCoinETH
 __   __  ___   _______    __   __  _______  _______    _______  _______  ___   __    _ 
|  | |  ||   | |       |  |  | |  ||       ||       |  |       ||       ||   | |  |  | |
|  |_|  ||   | |    _  |  |  |_|  ||   _   ||    _  |  |       ||   _   ||   | |   |_| |
|       ||   | |   |_| |  |       ||  | |  ||   |_| |  |       ||  | |  ||   | |       |
|       ||   | |    ___|  |       ||  |_|  ||    ___|  |      _||  |_|  ||   | |  _    |
|   _   ||   | |   |      |   _   ||       ||   |      |     |_ |       ||   | | | |   |
|__| |__||___| |___|      |__| |__||_______||___|      |_______||_______||___| |_|  |__|
...
contract HIPHOP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"HIPHOPcoin";
    string private constant _symbol = unicode"HIPHOP";
