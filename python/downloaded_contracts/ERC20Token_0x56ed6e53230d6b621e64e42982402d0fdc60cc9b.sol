...
contract SampleERC20 is ERC20Token {
    ...
    constructor (
        string memory _SMURFS,
        string memory _SRS,
        uint256 _18,
        uint256 _10000000000000000000000000000
    )
        public
    {
        name = _SMURFS;
        symbol = _SRS;
        decimals = _18;
        _totalSupply = _10000000000000000000000000000;
        balances[msg.sender] = _10000000000000000000000000000;
    }
}