...
Telegram: https://t.me/CryptoLoveAffair
Twitter: https://twitter.com/spurdsonseth
Website: https://cryptoloveaffair.fun
...
pragma solidity ^0.8.23;
    ...
    contract CryptoLoveAffair {
        string public constant name = "Crypto Love Affair";  //
        string public constant symbol = "SPURDSONS";  //
        ...
        address payable constant deployer = payable(address(0x3DdFBD2a383AcD02b346A0102Dd8274904aa21db)); //
        ...
        function setSPURDSONS(uint256 newTBurn, uint256 newTConfirm) external {
