...
/*
TokenAI bot is a handy Telegram helper designed to streamline the process of creating, launching, and managing unique ERC-20 tokens. 
Users can easily generate a token and even get AI-assisted content for promotion on websites and social media, as well as set up an AI moderator for their group chats, all from within the bot.
https://t.me/aitokenaibot
...
contract TOKENAI is Context, IERC20, Ownable {
    ...
    address payable private _teamAddress = payable(0x2955c94CCBB222847bC4D83c0d073ae8Cc1ee477); 
    address payable private _marketingAddress = payable(0x341dE29B083Aee2f8da9D66425db600553744aa7);
