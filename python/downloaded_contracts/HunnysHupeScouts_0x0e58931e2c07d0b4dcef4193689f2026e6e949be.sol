...
// File contracts/HunnysHupeScouts.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.0;
/// @title HunnysHupeScouts

contract HunnysHupeScouts is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, ERC721RoyaltyUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    string private _contractURI;
    uint256 private _tokenIdCounter;

    // Initialize the contract
    function initialize(string memory name, string memory symbol, string memory contractURI_) public initializer {
    ...
    function setRoyalties(address recipient, uint96 bps) public onlyOwner {
