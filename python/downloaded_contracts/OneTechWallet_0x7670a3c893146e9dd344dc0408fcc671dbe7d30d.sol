...
OneTech Wallet (c) OneTech DAO
Community Private Sale Round
...
contract OneTechWallet is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"OneTech Wallet";
    string private constant _symbol = unicode"OTW";
 ...
 returns (uint256){
    ...
    function removeLimets() external onlyOwner{
