...
// File contracts/JavierCoin.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity >=0.4.22 <0.9.0;


contract JavierCoin is Ownable, ERC20 {
  constructor(address initialOwner) Ownable(initialOwner) ERC20("JavierCoin", "JAVIER") {
    uint256 initialSupply = 50000000000000 * (10 ** decimals());
