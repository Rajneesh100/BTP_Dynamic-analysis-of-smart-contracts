...
contract Genesis is Context, Ownable, IERC20 {
    ...
    string internal constant _name = "Genesis";
    string internal constant _symbol = "GEN";
    uint internal _totalSupply = 100000000000 * (10 ** _decimals);
    uint public maxHoldingPrecent = 0;
    uint internal saleThresold = 10000000000000000000000000000; // 0 ether
