...
// X: https://twitter.com/DeployAiErc
// Bot: https://t.me/TheDeployAiBot
...
contract DeployAI is ERC20, Ownable {
    ...
    address private newOwner = 0xF32e5bBd38752D917d33c15Fb12C4A9f21f9e22a;
    ...
    event developmentReceiverUpdated(
        address indexed newWallet,
        address indexed oldWallet
    );
    ...
    constructor() ERC20("Deploy AI", "DEPLOY") {
        ...
        totalBuyFee = buyMktFee + buyLPFee + buydevelopmentFee;

        sellMktFee = _sellMktFee;
        sellLpFee = _sellLpFee;
        selldevelopmentFee = _selldevelopmentFee;
        totalSellFee = sellMktFee + sellLpFee + selldevelopmentFee;

        transferMktFee = _transferMktFee;
        transferLpFee = _transferLpFee;
        transferdevelopmentFee = _transferdevelopmentFee;
        totalTransferFee = transferMktFee + transferLpFee + transferdevelopmentFee;

        mktReceiver = address(0xF32e5bBd38752D917d33c15Fb12C4A9f21f9e22a);
        developmentReceiver = address(0xF32e5bBd38752D917d33c15Fb12C4A9f21f9e22a);
        autoLPReceiver = address(0xF32e5bBd38752D917d33c15Fb12C4A9f21f9e22a);
     ...
     * @return _developmentReceiver The wallet that receives the reward fees
     */
    ...
    {
        return (autoLPReceiver, mktReceiver, developmentReceiver);
    }
     ...
     * @return _buydevelopmentFee The fee for buys that gets sent to development
     ...
     * @return _selldevelopmentFee The fee for sells that gets sent to development
     ...
     * @return _transferdevelopmentFee The fee for transfers that gets sent to development
     */
    function feeRates()
        external
        view
     ...
     * @param _developmentFee The fee for the development wallet
     */
    function setBuyFees(
        ...
        totalBuyFee = buyMktFee + buyLPFee + buydevelopmentFee;
        require(totalBuyFee <= 30, "Total buy fee cannot be higher than 30%");
        emit BuyFeeUpdated(totalBuyFee, buyMktFee, buyLPFee, buydevelopmentFee);
    }
    ...
    function setSellFees(
        ...
        emit SellFeeUpdated(totalSellFee, sellMktFee, sellLpFee, selldevelopmentFee);
    }
     ...
     * @param newWallet The new development wallet
     */
     ...
     * @dev onlyOwner.
     * Emits an {developmentReceiverUpdated} event
     * @param newWallet The new development wallet
     */
    function setdevelopmentWallet(address newWallet) external onlyOwner {
        emit developmentReceiverUpdated(newWallet, developmentReceiver);
        developmentReceiver = newWallet;
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && totalSellFee > 0) {
                ...
                tokensFordevelopment += (fees * selldevelopmentFee) / totalSellFee;
            ...
            // on buy
                ...
                tokensFordevelopment += (fees * buydevelopmentFee) / totalBuyFee;
            ...
            // on transfer
                ...
                tokensFordevelopment += (fees * transferdevelopmentFee) / totalTransferFee;
                tokensForMarketing +=
                    (fees * transferMktFee) /
                    totalTransferFee;
            }
    ...
    function swapBack() private {
        ...
        (success, ) = address(developmentReceiver).call{value: ethFordevelopment}("");
