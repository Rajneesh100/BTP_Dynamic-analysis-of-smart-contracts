...
contract G7 is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"7,777,777", unicode"G7") {
        ...
        maxTransactionAmount = 155_555 * 1e18; // 2% max txn at launch
        maxWallet = 155_555 * 1e18; // 2% max wallet at launch
        ...
        mwallet = address(0xB4E98C06890193bF48734499dD397A3107A880Ec); 
        devWallet = address(0xe4C1647A084Ce277FA37aB1ffb33E41C4F7e6dEC); 
        liqWallet = address(0xCaf36c4ad254809EC380e78dB692d62c95A0FF29); 
        operationsWallet = address(0xe8c4a71131a19D1f162da9689D65c8769c9718bB);
