...
contract BTCETHDOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BETCETHDOGELETSGO";
    string private constant _symbol = unicode"BTCETHDOGE";
