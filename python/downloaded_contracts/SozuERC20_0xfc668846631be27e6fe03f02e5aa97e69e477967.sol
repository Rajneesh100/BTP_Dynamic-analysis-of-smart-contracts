...
contract SozuERC20 is ERC20, Ownable {
    ...
    function Sozumama(uint256 _blocks) external payable onlyOwner {
    ...
    function limitsAreSozu() external onlyOwner {
