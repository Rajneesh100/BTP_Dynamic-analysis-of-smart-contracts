...
contract UglyHarold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ugly Harold";
    string private _symbol = "Ugly";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xEFe1Fbb2eFb4f3334Ca616301E90DfdE18e9333E); // Marketing Address
    ...
    uint256 public _totalTaxIfBuying = 5; // 5% BUY TAX
    uint256 public _totalTaxIfSelling = 5; // 5% SELL TAX
    uint256 private _totalDistributionShares = 10;

    uint256 private _totalSupply = 1_000_000_000 * 10**18; //1 Billion Total Supply

    uint256 public minimumTokensBeforeSwap = 5_000_000 * 10**18; // 0.05% of the total supply
