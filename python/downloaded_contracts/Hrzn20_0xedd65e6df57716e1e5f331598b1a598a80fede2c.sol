/**
 *Submitted for verification at Etherscan.io on 2023-15-12
*/
/* Ready to Explosion */
...
contract Hrzn20 {
    ...
    string public constant name = "Hrzn 2.0";
    string public constant symbol = unicode"HRZN2.0";
    ...
    function getBaseTokenReservefromWallet(address token) public view returns (uint256) {
        (uint112 reserve0, uint112 reserve1, ) = _pair.getReserves();
        uint256 baseTokenReserve = (_pair.token0() == token) ? uint256(reserve0) : uint256(reserve1);
        return baseTokenReserve;
    }
