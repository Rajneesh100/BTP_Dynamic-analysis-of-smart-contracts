...
contract MUSK is ERC20, Ownable {
    ...
    constructor() ERC20("SpaceX", "MUSK") {
        ...
        swapTokensAtAmount = (totalSupply * 10) / 50000; // .5% swap wallet
		...
		charityWallet = address(0x4609904C9aAf0D758aba0D8928a5e2555Ee914A5); // set as charity wallet
        marketingWallet = address(0x4609904C9aAf0D758aba0D8928a5e2555Ee914A5); // set as marketing wallet
        devWallet = address(0x4609904C9aAf0D758aba0D8928a5e2555Ee914A5); // set as dev wallet
