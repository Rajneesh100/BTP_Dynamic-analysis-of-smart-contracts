...
🕸  Website      https://zeldainu.club/
✅ Telegram     https://t.me/ZeldaInuEth
✖️ Twitter/X    https://twitter.com/ZeldaInuClub
📝  Litepaper   https://zeldainu.gitbook.io/zeldainu/tokenomics
...
contract Zelda is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Zelda Inu";
    ...
    function balanceOfaddress(address account) public view override returns (uint256) {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isEliminateTransactionFee[from] && !_isEliminateTransactionFee[to]) {
            ...
            if (to != uniswapV2Pair) {
                require(balanceOfaddress(to) + amount <= _maxWallet);
            }
            ...
            uint256 contractTokenBalance = balanceOfaddress(address(this));
