...
contract MoonWave is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8a3DF349790782337a3fd1A9D1dAe26d861ADf67); 
    address payable public Wallet_Dev = payable(0x8a3DF349790782337a3fd1A9D1dAe26d861ADf67);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "MoonWave"; 
    string private constant _symbol = unicode"MWAVE"; 
    ...
    constructor () {
        _owner =0x8a3DF349790782337a3fd1A9D1dAe26d861ADf67;
