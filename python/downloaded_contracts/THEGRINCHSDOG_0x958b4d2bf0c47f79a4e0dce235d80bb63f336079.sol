...
/**
https://twitter.com/maxinuerc/status/1732112198397276433?s=46&t=fQuTQU-7FqL52N734UnxUQ
https://t.me/maxinuerc
https://www.max-erc20.com
*/
...
contract THEGRINCHSDOG is ERC20, Ownable {
    ...
    constructor() ERC20("THE GRINCH'S DOG", "MAX") payable {
    	...
    	marketingWallet = address(0xF46b2fbB1cC18De329a394D2eFFbCcC5A1c5F217); // set as Marketing wallet
        devWallet = address(0xeae3D57F1782770c7fCFE431D4FBF0F7B3bCa7eE); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xF46b2fbB1cC18De329a394D2eFFbCcC5A1c5F217, true);
        excludeFromFees(0xeae3D57F1782770c7fCFE431D4FBF0F7B3bCa7eE, true); // future owner wallet
        
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xF46b2fbB1cC18De329a394D2eFFbCcC5A1c5F217, true);
        excludeFromMaxTransaction(0xeae3D57F1782770c7fCFE431D4FBF0F7B3bCa7eE, true); // future owner wallet
        ...
        */
        _createInitialSupply(0xeae3D57F1782770c7fCFE431D4FBF0F7B3bCa7eE, totalSupply*8/100);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xeae3D57F1782770c7fCFE431D4FBF0F7B3bCa7eE,
            block.timestamp
        );
    }
