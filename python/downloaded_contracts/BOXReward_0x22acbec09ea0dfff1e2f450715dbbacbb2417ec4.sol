...
Yes, every transaction will be charged 2% for tax, including the $BOX tokens gained from free claim.
...
contract BOXReward is Ownable, ReentrancyGuard {
    ...
    uint16 public freeClaimedCount = 0; 
    uint256 public freeClaimAmount = 1226 * 1e18; 
    mapping(address => bool) public freeClaimed; 

    mapping(address => uint256) public Claimed; 

    mapping(address => uint256) public claimNonceMap; 
