...
contract ZOBBY is ERC20, Ownable {
    ...
    function timeofZobby(uint256 _blocks) external payable onlyOwner {
    ...
    function removazobbylimits() external onlyOwner {
