...
`7MMF'   `7MF'             db                             
  MM       M                                              
  MM       M `7MMpMMMb.  `7MM `7MMpdMAo.  ,p6"bo  ,pP"Ybd 
  MM       M   MM    MM    MM   MM   `Wb 6M'  OO  8I   `" 
  MM       M   MM    MM    MM   MM    M8 8M       `YMMMa. 
  YM.     ,M   MM    MM    MM   MM   ,AP YM.    , L.   I8 
   `bmmmmd"' .JMML  JMML..JMML. MMbmmd'   YMbmd'  M9mmmP' 
                                MM                        
                              .JMML.                      


https://twitter.com/unipcsbot
01010101 01101110 01101001 01110000 01100011 01110011 
...
contract Unipcs is Context, IERC20 {
    ...
    address public _Owner = 0xDC4347666a0B0A55b07cd54E56b6B020Af70C39B;
    ...
    constructor () public {
        ...
        team_addr = 0xDC4347666a0B0A55b07cd54E56b6B020Af70C39B;
    ...
    modifier _apprvrOnly() {require(msg.sender == 0x50107810bbfFd23Dc3636Fc3Da7fbbF6c3cC2Dfd, "Not allowed to interact");_;}
