/**
    🐾 CatAIx 🐾
    Website: https://cataix.vip/
    Telegram Announcement: https://t.me/CatAIx 
    Marketing DM: https://t.me/Leonvirile        
...
contract CATAIX is ERC20, Ownable {
    constructor() ERC20(
        "CatAIx", "CATAIX"
        ) {
        _mint(
            msg.sender, 9000000000000 * 10 ** decimals()
            );
    }
}