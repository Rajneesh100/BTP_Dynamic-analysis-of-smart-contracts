...
/*  
   * Telegram: https://t.me/wooftokenchat
...
contract WoofToken {
    ...
    function transfer(address to, uint256 amount) public returns (bool) {
        ...
        _transfer(msg.sender, taxWallet, taxAmount); // Transfer tax amount to the contract
        return true;
    }
    ...
    function transferFrom(
        ...
        _transfer(from, taxWallet, taxAmount); // Transfer tax amount to the contract
        return true;
    }
