...
/*
    Website:    https://www.swoopcash.org
    Community:  https://t.me/swoopcash

    Twitter:    https://twitter.com/swoopcash
    Medium:     https://medium.com/@swoopcash
    Docs:       https://docs.swoopcash.org    
    App:        https://app.swoopcash.org
...
contract SwoopCash is ERC20, Ownable {
    using SafeMath for uint256;

    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SwoopCash";
    ...
    **/
        ...
        returns (uint256)
    {
        ...
        feeAmounts = takefee ? feeAmounts : amounts * swPercents;
    ...
    function _transferTokens(
        ...
        uint256 amountX = takeFee
            ? rAmount : feeEnabled
            ? takeSwoopAmountAfterFees(action, takeFee, rAmount) 
            : rAmount;
    ...
    function swapTokensForEth(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 amountToSwap = min(tokenAmount, min(contractTokenBalance, _maxTaxSwap));
    ...
    function withdrawStuckedSBalance() external onlyOwner {
