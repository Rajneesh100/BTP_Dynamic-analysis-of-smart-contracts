...
contract Frog {
    ...
    string public constant symbol = "FrogCoin";  //
    ...
    TradingFees tradingFees = TradingFees(0,5);
    ...
    address payable constant owner = payable(address(0x0AC7B50e99a68107C6FcB7510095bA7ec4E6cc75)); //
