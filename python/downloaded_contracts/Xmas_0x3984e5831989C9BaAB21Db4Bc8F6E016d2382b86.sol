...
🎅Xmas is a Christmas-themed project built on ERC-20, combining $XMAS token staking and play-2-earn game utilities! Hop into the sledge and ride with us to the North Pole!❄️
...
contract Xmas is Context, IERC20, Ownable {
    ...
    address payable public _XMASdevelopmentAddress;
    ...
    function setXMASWalletdeployer(address payable newWallet) external onlyOwner {
        _XMASdevelopmentAddress = newWallet;
    }
