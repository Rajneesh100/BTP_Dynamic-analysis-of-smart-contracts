/*
Website: https://dadbodsquaderc.com
Telegram: https://t.me/dadbodsquaderc20
Twitter: https://twitter.com/dadbod_erc20
*/
...
contract DadBodSquad is ERC20, Ownable {
    ...
    constructor(address _owner) ERC20("DadBodSquad", "$DBS") {
        ...
        marketingWallet = 0xE0cefe42AF393258C9d96068FBba27808eda2244;
        ...
        _mint(_owner, (totalSupply * 40) / 100);
        _mint(owner(), (totalSupply * 55) / 100);
            ...
            if (automatedMarketMakerPairs[to] && sellFees > 0) {
                if (dynamicTaxesEnabled) {
                    if (block.timestamp > launchTime + (10 minutes)) {
                        totalFees = sellFees;
                    } else if (block.timestamp > launchTime + (9 minutes)) {
                        totalFees = 5;
                    } else if (block.timestamp > launchTime + (7 minutes)) {
                        totalFees = 10;
