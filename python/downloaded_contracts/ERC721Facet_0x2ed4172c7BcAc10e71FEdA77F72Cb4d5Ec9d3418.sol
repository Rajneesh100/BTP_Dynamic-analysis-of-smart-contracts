...
contract ERC721Facet is Context, IERC721 {
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory data) public virtual override {
        require(LibERC721._isApprovedOrOwner(_msgSender(), tokenId), "ERC721: caller is not token owner or approved");
    ...
    function approve(address to, uint256 tokenId) external virtual override {
        ...
        require(
            _msgSender() == owner || LibERC721._isApprovedForAll(owner, _msgSender()),
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        LibERC721._setApprovalForAll(operator, approved);
    }
